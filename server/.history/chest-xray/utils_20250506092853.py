...
# Update these with your optimal thresholds from the notebook
thresholds = [
    0.5, 0.5, 0.5, 0.5, 0.5,  # Placeholder values - replace with your actual thresholds
    0.5, 0.5, 0.5, 0.5, 0.5,
    0.5, 0.5, 0.5, 0.5
]
...
if __name__ == "__main__":
    # Try to create templates folder if it doesn't exist
