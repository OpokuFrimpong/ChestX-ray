        ...
        <div className="lung-analyzer-container">
            ...
            {analysisResults && (
                <div className="analyzer-right-panel">
                        ...
                        <div className="all-probabilities">
                            ...
                            <div className="probability-list">
                                {analysisResults.probabilities && analysisResults.probabilities.length > 0 ? (
                                    <>
                                        {/* Show only high-probability conditions (85%+) */}
                                        ...
                                        >
                                            {showAllProbabilities ? "Hide low confidence results" : "Show all results"}
                                        </button>
                                        
                                        {/* Show all probabilities when toggled */}
                                        {showAllProbabilities && (
                                            <div className="all-probabilities-list">
                                                <h4>All Detected Conditions:</h4>
                    ...
                    {/* Add download buttons below the results card */}
                    {analysisResults && (
                        <div className="download-options">
                            <button onClick={downloadResultsAsPDF} className="download-btn pdf-btn">
