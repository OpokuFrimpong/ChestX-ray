        ...
        <div className="landing-page">
            ...
            <header className="hero-section">
                <div className="hero-content">
                    <h1>Welcome to eature 5: Model Confidence Scores
                    See how confident the system is in its predictions, aiding human-in-the-loop decision</h1>
                    <p>Your one-stop solution for [App's Purpose].</p>
