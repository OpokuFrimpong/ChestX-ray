    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            const formattedResults = {
                ...
                probabilities: [],
                detectedConditions: results.detected_conditions || [] // Store detected conditions
            };
            ...
            if (results.predictions) {
                ...
                formattedResults.probabilities = Object.entries(results.predictions)
                    .map(([label, probability]) => ({
                        ...
                        detected: results.detected_conditions && results.detected_conditions.includes(label)
                    }))
