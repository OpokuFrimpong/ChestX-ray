...
const Uploader = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            // Create a properly formatted result with default values
            const formattedResults = {
                primary: "Analysis Complete",
                description: "Analysis completed successfully.",
                probabilities: [] // Default empty array to prevent undefined
            };
            
            // Process the results
            if (results.primary && results.description) {
                formattedResults.primary = results.primary;
                formattedResults.description = results.description;
                
                // Make sure probabilities exists even if not in the original response
                if (results.probabilities) {
                    formattedResults.probabilities = results.probabilities;
                }
            } 
            else if (results.predictions && results.hasOwnProperty('detected_conditions')) {
                ...
                // Convert predictions to our probability format
